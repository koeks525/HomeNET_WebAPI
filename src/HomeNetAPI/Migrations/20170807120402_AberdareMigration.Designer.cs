...
namespace HomeNetAPI.Migrations
{
    ...
    [Migration("20170807120402_AberdareMigration")]
    partial class AberdareMigration
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("HomeNetAPI.Models.HousePostComment", b =>
                {
                    b.Property<int>("HousePostCommentID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("HousePostCommentID");

                    b.HasIndex("HouseMemberID");

                    b.HasIndex("HousePostID");

                    b.ToTable("HousePostComment");
                });
